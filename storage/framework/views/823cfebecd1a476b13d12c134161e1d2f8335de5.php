        ...
        <div class="wrapper row">
          <div class="preview col-md-6">
            ...
            <div class="preview-pic tab-content">
              <div class="tab-pane active" id="pic-1"><img src="<?php echo e(url('public')); ?>/assets/img/dummyimg.png" /></div>
              <div class="tab-pane" id="pic-2"><img src="<?php echo e(url('public')); ?>/assets/img/dummyimg.png" /></div>
              <div class="tab-pane" id="pic-3"><img src="<?php echo e(url('public')); ?>/assets/img/dummyimg.png" /></div>
              <div class="tab-pane" id="pic-4"><img src="<?php echo e(url('public')); ?>/assets/img/dummyimg.png" /></div>
            ...
            <ul class="preview-thumbnail nav nav-tabs">
              ...
              <li><a data-target="#pic-2" data-toggle="tab"><img src="<?php echo e(url('public')); ?>/assets/img/dummyimg.png" /></a></li>
              <li><a data-target="#pic-3" data-toggle="tab"><img src="<?php echo e(url('public')); ?>/assets/img/dummyimg.png" /></a></li>
              <li><a data-target="#pic-4" data-toggle="tab"><img src="<?php echo e(url('public')); ?>/assets/img/dummyimg.png" /></a></li>
          ...
          <div class="details col-md-6">
            ...
            <div class="action">
              ...
              <a href="<?php echo e(url('/')); ?>" class="btn btn-primary  btn-xs">Kembali</a>
...
</html><?php /**PATH C:\xampp\htdocs\materi-2\system\resources\views/Produk.blade.php ENDPATH**/ ?>