                            ...
                            <div class="col-lg">
                                <div class="p-5">
                                    ...
                                    <form class="user">
                                        ...
                                        <div class="text-center">
                                            <a class="small" href="<?php echo e(url('berandaUser')); ?>">Login</a>
                                        </div>
                                    ...
                                    <div class="text-center">
                                        <a class="small" href="<?php echo e(url('registerUser')); ?>">Create an Account!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
</html><?php /**PATH C:\xampp\htdocs\blog\system\resources\views/login/baselogin.blade.php ENDPATH**/ ?>