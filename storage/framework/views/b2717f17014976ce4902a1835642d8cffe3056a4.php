                            ...
                            <div class="col-lg">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">TOLEKTRO</h1>
                                    </div>
                                    <form class="user">
                                        ...
                                        <div class="text-center">
                                            <a class="small" href="<?php echo e(url('berandaAdmin')); ?>">Login</a>
                                        </div>
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="<?php echo e(url('/')); ?>">Forgot Password?</a>
                                    </div>
                                    <div class="text-center">
                                        <a class="small" href="<?php echo e(url('registerAdmin')); ?>">Create an Account!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
</html><?php /**PATH C:\xampp\htdocs\blog\system\resources\views/login/baseloginAdmin.blade.php ENDPATH**/ ?>