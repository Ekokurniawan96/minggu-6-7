    ...
    <di class="row">
        <div class="col-md-3">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(url('produkUser/filter')); ?>" method="post">
                        <?php echo csrf_field(); ?>
        ...
        <div class="col-md-9">
            ...
            <!-- /.row -->
            <div class="row">
                <?php $__currentLoopData = $list_produk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $produkUser): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="col-md-4 text-center col-sm-6 col-xs-6">
                    <div class="thumbnail product-box">
                        ...
                        <div class="caption">
                            ...
                            <h3><a href="#"> <?php echo e($produkUser->nama); ?> </a></h3>
                            <h3><a href="#"> STOK |<?php echo e($produkUser->stok); ?> Buah </a></h3>
                            <p><a href="#" class="btn btn-success" role="button">Add To Cart</a> <a href="<?php echo e(url('produkUser', $produkUser->id)); ?>" class="btn btn-primary" role="button">See Details</a></p>
...
<?php echo $__env->make('users.baseUser', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\blog\system\resources\views/users/beranda.blade.php ENDPATH**/ ?>