...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                <li class="nav-item">
                    <a href="<?php echo e(url('berandaAdmin')); ?>" class="nav-link <?php echo e(checkRouteActive('berandaAdmin')); ?> ">
                ...
                <li class="nav-item">
                    <a href="<?php echo e(url('admin/produkAdmin')); ?>" class="nav-link <?php echo e(checkRouteActive('admin/produkAdmin')); ?> ">
                        <i class="nav-icon fas fa-home"></i>
                        <p>
                            Produk
                        </p>
                ...
                <li class="nav-item">
                    <a href="<?php echo e(url('admin/kategoriAdmin')); ?>" class="nav-link <?php echo e(checkRouteActive('admin/kategoriAdmin')); ?>">
                        <i class="nav-icon fas fa-home"></i>
                        <p>
                            Kategori
                        </p>
    ...
    <!-- /.sidebar -->
</aside><?php /**PATH C:\xampp\htdocs\blog\system\resources\views/template/sectionAdmin/sidebar.blade.php ENDPATH**/ ?>